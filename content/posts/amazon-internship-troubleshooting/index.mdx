...
That log pattern was a common training signal: event trigger worked, function ran, downstream permission failed. The fix path was not guesswork. It was: inspect execution role, verify policy action and resource scope, redeploy, and rerun the upload test.
