...
<div className="tldr-card">
	<ul>
		<li><strong>Outcome:</strong> Solved a winter CTF by decoding a chained ladder of **JWT access tokens** guarding layered gRPC endpoints.</li>
		<li><strong>Proof:</strong> Used Libsodium, `grpcurl`, and custom Python scripts to verify signatures, rotate credentials, and capture proxy responses.</li>
		<li><strong>Action:</strong> Flagged AWS load balancer 464 errors caused by **metadata casing** and `application/grpc` mismatches, guiding next retries.</li>
	</ul>
</div>
