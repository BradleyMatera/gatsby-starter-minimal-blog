...
description: "A breakdown of the AI development tools I actually use: editors, terminal tools, local and hosted models, and what each one is good and bad at in practice."
theme: "Process"
---
...
{/* visual-break:my-real-ai-development-setup:1 */}
![AI workflow checkpoint illustration for this section.](/assets/visuals/blog/my-real-ai-development-setup-break-1.png)
...
Cline is a VS Code extension that acts like an agent. The important detail is not that it can chat. The important detail is that it can see the repo and operate on it. It can browse the file tree, open files, propose patches in the right places, run commands, then react to the output that comes back. ([Cline on GitHub](https://github.com/cline/cline))
...
When I say Qwen here, I mean the Qwen models I have run locally through Ollama. I like them for the boring, constant, real tasks that every repo has. They are fast enough that you can keep them “on” mentally and just use them like a helper while you work. ([Qwen on Hugging Face](https://huggingface.co/Qwen))
...
Claude is the model I switch to when the problem stops being “small code work” and becomes “reasoning work.” Multi-file bugs. Messy code that needs a rewrite without changing behavior. Build errors that have more than one root cause. Situations where you need an explanation that maps back to your files and not just a generic answer. ([Claude by Anthropic](https://www.anthropic.com/claude))
...
Copilot is autocomplete. That is the honest description. It is good at finishing JSX lines, filling in small helper functions, and saving you from typing boilerplate. It is not good at owning architecture decisions or understanding your whole repo. ([GitHub Copilot](https://github.com/features/copilot))
...
{/* visual-break:my-real-ai-development-setup:2 */}
![Automation loop checkpoint illustration for this section.](/assets/visuals/blog/my-real-ai-development-setup-break-2.png)
...
## Proof this setup is real

This site and its content were built using exactly this toolchain:

- [This site's GitHub repo](https://github.com/BradleyMatera/gatsby-starter-minimal-blog) — visible commit history showing AI-assisted development
- [Automated test suite](https://github.com/BradleyMatera/gatsby-starter-minimal-blog/blob/master/scripts/verify-site.js) — 234 assertions that verify every build
- [Lighthouse scores](https://bradleymatera.dev) — SEO 100, Accessibility 98, verified on every deploy

## Keep reading

- [End to End Projects With AI: A Strict, Verifiable Workflow](/ai-end-to-end-projects/)
- [Balancing Work, School, and Projects: A Simple Schedule](/balancing-school-work-projects/)
