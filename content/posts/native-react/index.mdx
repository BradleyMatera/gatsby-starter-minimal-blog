...
> **Context:** Personal React + AWS API Gateway experiment (private repo) I built to practise CRUD flows—no paying users, just lab traffic.  
> **AI assist:** ChatGPT + Copilot scaffolded some components/endpoints; I kept a prompt log in the repo.  
> **Status:** Honest case study: the project runs, but features like auth/uploads/infra modules remain TODOs.
