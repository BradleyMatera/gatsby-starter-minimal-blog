...
description: "A detailed look at how I built ProjectHub and Scout using vanilla JavaScript, GitHub Pages, a GCP e2-micro VM, grounded data, multiple free LLM providers, analytics, safety checks, and a self-improvement system."
theme: "AI"
---
...
My portfolio is scattered. Projects live on GitHub, demos live on various subdomains, blog posts are on the site, certifications are listed somewhere, and my actual AWS internship experience is explained in a few different places. A motivated recruiter could piece it all together, but most recruiters are not motivated. They are busy.
