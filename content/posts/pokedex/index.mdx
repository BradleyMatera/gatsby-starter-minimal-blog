...
description: "A minimal static Pokedex build with vanilla JavaScript and PokéAPI: fetch data, render cards, add search filtering, and handle loading and error states cleanly."
theme: "Front-End"
---
