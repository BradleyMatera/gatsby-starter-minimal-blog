...
import { Section, Card, Link } from "../../../src/components/ui";
...
<Section
  ...
  description={
    <>
      <p>
        <strong>Send the essentials up front</strong>—the problem, desired outcomes, and any constraints—and I’ll reply within one business day with the next steps.
      </p>
...
>
  <Card className="contact-card reveal-card">
    <div className="contact-info">
      ...
      <p className="contact-info__note">Typical response time: within one business day. Mention if you prefer Slack, Teams, or scheduled calls.</p>
    </div>
    <div className="contact-form">
      ...
      <p className="contact-info__note">Need NDAs or procurement docs? Attach them to the email and I’ll return a countersigned copy with the kickoff notes.</p>
    </div>
  </Card>
</Section>
