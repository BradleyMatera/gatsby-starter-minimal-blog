  ...
  <Layout>
    ...
    >
      ...
      <div className="grid-three" style={{ marginTop: "1.5rem" }}>
        ...
        <div className="pkg-card">
          <img src="/package-images/city-demo-salon.svg" alt="Salon Website illustration" className="pkg-card__bg" loading="lazy" />
          <div className="pkg-card__body">
            <h3 className="pkg-card__title">Salon Website</h3>
            <p className="pkg-card__desc">
    ...
    >
      <div className="grid-three">
        <div className="pkg-card">
          <img src="/package-images/city-location-pin.svg" alt="Durand, Illinois illustration" className="pkg-card__bg" loading="lazy" />
          <div className="pkg-card__body">
            <h3 className="pkg-card__title">Durand, Illinois</h3>
            <p className="pkg-card__desc">
        ...
        <div className="pkg-card">
          <img src="/package-images/city-area-served.svg" alt="Davis, Illinois illustration" className="pkg-card__bg" loading="lazy" />
          <div className="pkg-card__body">
            <h3 className="pkg-card__title">Davis, Illinois</h3>
            <p className="pkg-card__desc">
        ...
        <div className="pkg-card">
          <img src="/package-images/city-map-region.svg" alt="Nearby Northwest Illinois illustration" className="pkg-card__bg" loading="lazy" />
          <div className="pkg-card__body">
            <h3 className="pkg-card__title">Nearby Northwest Illinois</h3>
            <p className="pkg-card__desc">
    ...
    >
      <div className="grid-three">
        <div className="pkg-card">
          <img src="/package-images/city-typically-work-with.svg" alt="Rockford, Illinois illustration" className="pkg-card__bg" loading="lazy" />
          <div className="pkg-card__body">
            <h3 className="pkg-card__title">Rockford, Illinois</h3>
            <p className="pkg-card__desc">
        ...
        <div className="pkg-card">
          <img src="/package-images/city-small-business.svg" alt="Freeport, Illinois illustration" className="pkg-card__bg" loading="lazy" />
          <div className="pkg-card__body">
            <h3 className="pkg-card__title">Freeport, Illinois</h3>
            <p className="pkg-card__desc">
        ...
        <div className="pkg-card">
          <img src="/package-images/city-service-area.svg" alt="Pecatonica &amp; Winnebago illustration" className="pkg-card__bg" loading="lazy" />
          <div className="pkg-card__body">
            <h3 className="pkg-card__title">Pecatonica &amp; Winnebago</h3>
            <p className="pkg-card__desc">
      ...
      <div className="grid-three" style={{ marginTop: "1.5rem" }}>
        <div className="pkg-card">
          <img src="/package-images/city-crossroads.svg" alt="Loves Park &amp; Machesney Park illustration" className="pkg-card__bg" loading="lazy" />
          <div className="pkg-card__body">
            <h3 className="pkg-card__title">Loves Park &amp; Machesney Park</h3>
            <p className="pkg-card__desc">
        ...
        <div className="pkg-card">
          <img src="/package-images/city-nearby-towns.svg" alt="Byron, Roscoe &amp; Rockton illustration" className="pkg-card__bg" loading="lazy" />
          <div className="pkg-card__body">
            <h3 className="pkg-card__title">Byron, Roscoe &amp; Rockton</h3>
            <p className="pkg-card__desc">
        ...
        <div className="pkg-card">
          <img src="/package-images/city-faq-county.svg" alt="South Beloit, Beloit &amp; Janesville illustration" className="pkg-card__bg" loading="lazy" />
          <div className="pkg-card__body">
            <h3 className="pkg-card__title">South Beloit, Beloit &amp; Janesville</h3>
            <p className="pkg-card__desc">
    ...
    >
      <div className="grid-three">
        <div className="pkg-card">
          <img src="/package-images/city-available-in-person.svg" alt="I live here illustration" className="pkg-card__bg" loading="lazy" />
          <div className="pkg-card__body">
            <h3 className="pkg-card__title">I live here</h3>
            <p className="pkg-card__desc">
        ...
        <div className="pkg-card">
          <img src="/package-images/city-knows-market.svg" alt="Knows the community illustration" className="pkg-card__bg" loading="lazy" />
          <div className="pkg-card__body">
            <h3 className="pkg-card__title">Knows the community</h3>
            <p className="pkg-card__desc">
        ...
        <div className="pkg-card">
          <img src="/package-images/city-accountable.svg" alt="Invested in the area illustration" className="pkg-card__bg" loading="lazy" />
          <div className="pkg-card__body">
            <h3 className="pkg-card__title">Invested in the area</h3>
            <p className="pkg-card__desc">
    ...
    >
      <div className="grid-two">
        <div className="pkg-card">
          <img src="/package-images/city-smaller-personal.svg" alt="No commute overhead illustration" className="pkg-card__bg" loading="lazy" />
          <div className="pkg-card__body">
            <h3 className="pkg-card__title">No commute overhead</h3>
            <p className="pkg-card__desc">
        ...
        <div className="pkg-card">
          <img src="/package-images/city-agency-right-call.svg" alt="When a bigger shop is the right call illustration" className="pkg-card__bg" loading="lazy" />
          <div className="pkg-card__body">
            <h3 className="pkg-card__title">When a bigger shop is the right call</h3>
            <p className="pkg-card__desc">
    ...
    >
      <div className="grid-two">
        ...
        <div className="pkg-card">
          <img src="/package-images/city-website-repair.svg" alt="How I usually help illustration" className="pkg-card__bg" loading="lazy" />
          <div className="pkg-card__body">
            <h3 className="pkg-card__title">How I usually help</h3>
            <p className="pkg-card__desc">
