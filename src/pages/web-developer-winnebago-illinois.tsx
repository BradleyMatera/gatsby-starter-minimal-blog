  ...
  <Layout>
    ...
    >
      <div className="grid-two">
        ...
        <div className="pkg-card">
          <img src="/package-images/city-local-advantage.svg" alt="Being near Rockford but not Rockford illustration" className="pkg-card__bg" loading="lazy" />
          <div className="pkg-card__body">
    ...
    >
      <div className="grid-three">
        <div className="pkg-card">
          <img src="/package-images/city-knows-market.svg" alt="Knows the Winnebago market illustration" className="pkg-card__bg" loading="lazy" />
          <div className="pkg-card__body">
