...
const ExamplePage = () => (
  <Layout>
    ...
    <Section eyebrow="Q&A" title="Common questions about HVAC websites">
      <div className="pkg-card">
        <img src="/package-images/why-fixed.svg" alt="Why does an HVAC business need service area pages? illustration" className="pkg-card__bg" loading="lazy" />
        <div className="pkg-card__body">
      ...
      <div style={{ marginTop: "1.5rem" }}>
        <div className="pkg-card">
          <img src="/package-images/why-fixed.svg" alt="What is a financing calculator and why include one? illustration" className="pkg-card__bg" loading="lazy" />
          <div className="pkg-card__body">
      ...
      <div style={{ marginTop: "1.5rem" }}>
        <div className="pkg-card">
          <img src="/package-images/why-fixed.svg" alt="Why seasonal promotion pages? illustration" className="pkg-card__bg" loading="lazy" />
          <div className="pkg-card__body">
