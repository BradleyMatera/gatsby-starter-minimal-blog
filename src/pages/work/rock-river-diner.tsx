  ...
  <Layout>
    ...
    >
      <div className="grid-three">
        ...
        <div className="pkg-card">
          <img src="/package-images/work-restaurant.svg" alt="Example type: Restaurant website illustration" className="pkg-card__bg" loading="lazy" />
          <div className="pkg-card__body">
    ...
    <Section eyebrow="Common starting point" title="What a typical restaurant site looks like before a rebuild">
      <div className="grid-three">
        <div className="pkg-card">
          <img src="/package-images/work-page-load.svg" alt="Page load time illustration" className="pkg-card__bg" loading="lazy" />
          <div className="pkg-card__body">
        ...
        <div className="pkg-card">
          <img src="/package-images/work-reservations.svg" alt="Reservations illustration" className="pkg-card__bg" loading="lazy" />
          <div className="pkg-card__body">
        ...
        <div className="pkg-card">
          <img src="/package-images/work-mobile-menu.svg" alt="Mobile menu illustration" className="pkg-card__bg" loading="lazy" />
          <div className="pkg-card__body">
    ...
    <Section eyebrow="Technical work" title="Accessibility, performance, and SEO">
      <div className="grid-three">
        ...
        <div className="pkg-card">
          <img src="/package-images/city-seo-services.svg" alt="SEO illustration" className="pkg-card__bg" loading="lazy" />
          <div className="pkg-card__body">
