  ...
  <Layout>
    ...
    >
      <div className="grid-two">
        ...
        <div className="pkg-card">
          <img src="/package-images/city-local-advantage.svg" alt="Why a local developer makes sense here illustration" className="pkg-card__bg" loading="lazy" />
          <div className="pkg-card__body">
            <h2 className="pkg-card__title">Why a local developer makes sense here</h2>
    ...
    >
      <div className="grid-three">
        ...
        <div className="pkg-card">
          <img src="/package-images/city-website-repair.svg" alt="Website help & repair illustration" className="pkg-card__bg" loading="lazy" />
          <div className="pkg-card__body">
      ...
      <div className="grid-two">
        ...
        <div className="pkg-card">
          <img src="/package-images/city-nearby-towns.svg" alt="Nearby communities I also serve illustration" className="pkg-card__bg" loading="lazy" />
          <div className="pkg-card__body">
    ...
    >
      <div className="grid-three">
        <div className="pkg-card">
          <img src="/package-images/city-knows-market.svg" alt="Knows the Pecatonica market illustration" className="pkg-card__bg" loading="lazy" />
          <div className="pkg-card__body">
            <h3 className="pkg-card__title">Knows the Pecatonica market</h3>
            <p className="pkg-card__desc">
    ...
    >
      <div className="grid-two">
        ...
        <div className="pkg-card">
          <img src="/package-images/city-faq-county.svg" alt="Other local pages illustration" className="pkg-card__bg" loading="lazy" />
          <div className="pkg-card__body">
