...
const integrations: Integration[] = [
  {
    ...
    description: "Live weather feed that triggers smart alerts on your site. When temps drop below 32°F, the site auto-shows a 'Is your furnace ready?' banner. When it hits 90°F+, it switches to AC messaging.",
  ...
  },
  {
    ...
    description: "Interactive map showing your service area. Customers can see if you cover their location before calling.",
  ...
  },
  {
    ...
    description: "Online booking, dispatch, technician tracking, invoicing, and CRM. Customer sees real-time tech ETA like Uber.",
    freeTier: "Housecall Pro from $49/month. ServiceTitan from $300/month.",
    url: "https://housecallpro.com",
    status: "available",
  },
  {
    name: "Synchrony Financing Widget",
    category: "Financing",
    description: "Embeddable financing application. Customers apply for 0% APR financing directly on your site. Instant decisions.",
    freeTier: "No monthly fee. Merchant discount rate per transaction.",
    url: "https://synchrony.com/business",
    status: "mocked",
  },
  {
    name: "Twilio SMS Dispatch",
    category: "Customer Communication",
    description: "Automated SMS: 'Your technician John is 15 minutes away' with live GPS tracking link. Reduces 'where are you?' calls by 80%.",
    freeTier: "Free trial. $0.0079 per SMS after.",
    url: "https://twilio.com/sms",
    status: "available",
  },
  {
    name: "BBB Accredited Business Badge",
    category: "Trust & Verification",
    description: "Live BBB rating badge that links to your BBB profile. Shows customers you're accredited and trustworthy.",
    freeTier: "BBB accreditation from $500/year (varies by region).",
    url: "https://bbb.org",
    status: "mocked",
  },
  {
    ...
    description: "Text or email a payment link after service. Customer pays with card or ACH. Funds in your account in 2 days.",
  ...
  return (
    <div className="demo-financing-calc">
      ...
      <div className="demo-financing-calc__slider-row">
        <div className="demo-financing-calc__slider-label">
          <span>Project Amount</span>
          <span className="demo-financing-calc__slider-value">{fmt(amount)}</span>
        </div>
        <input
          className="demo-financing-calc__slider"
          type="range"
          min="500"
          max="10000"
          step="100"
      ...
      <div className="demo-financing-calc__slider-row">
        <div className="demo-financing-calc__slider-label">
          <span>Term</span>
          <span className="demo-financing-calc__slider-value">{months} months</span>
        </div>
        <input
          className="demo-financing-calc__slider"
          type="range"
      ...
      <div className="demo-financing-calc__note">
        0% APR for 12 months on approved credit. After promo period, standard APR applies.
        Powered by Synchrony Financial. Production sites embed the real Synchrony application widget.
      </div>
    </div>
  );
};
        ...
        <div className="demo-two-col">
          <div>
            ...
            <div style={{ marginTop: "1rem", display: "flex", justifyContent: "center", gap: "0.75rem", flexWrap: "wrap" }}>
              ...
              <span className="demo-trust-logo">
                <ShieldIcon size={20} /> IL Licensed <span className="demo-trust-logo__rating">#058-204993</span>
              </span>
            </div>
          </div>
