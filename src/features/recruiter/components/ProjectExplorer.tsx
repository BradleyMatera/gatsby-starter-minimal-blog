...
const PROJECTS: Project[] = [
  ...
  },
  {
    id: "convo-ai",
    name: "Convo-AI",
    tagline: "Local voice-and-text assistant that runs privately on your machine",
    category: "AI Systems",
    description:
      "Built for people who want voice AI without sending conversations to third-party cloud APIs. FastAPI backend, Whisper STT, Ollama LLM, XTTS v2 TTS — all local.",
    tech: ["Python", "FastAPI", "Whisper", "Ollama", "XTTS v2", "WebSockets"],
    metrics: [
      { label: "Inference", value: "Local" },
      { label: "Modes", value: "Voice + Text" },
    ],
