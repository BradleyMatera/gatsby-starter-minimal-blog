...
const brandTheme = merge(tailwind, {
  ...
  colors: {
    ...
    surfaceAlt: `#efe9e0`,
    primary: `#7a6b5d`,
    primaryMuted: `rgba(122, 107, 93, 0.12)`,
    secondary: `#8d7d6e`,
    accent: `#7a6b5d`,
    muted: `#ddd5c9`,
    subtle: `#5b554e`,
    border: `#d8d0c4`,
    highlightLineBg: `rgba(122, 107, 93, 0.1)`,
    badgeBg: `rgba(122, 107, 93, 0.12)`,
    badgeText: `#2b2621`,
    ...
    modes: {
      dark: {
        ...
        surfaceAlt: `#121212`,
        primary: `#b0a89e`,
        primaryMuted: `rgba(176, 168, 158, 0.2)`,
        secondary: `#c0b8ae`,
        accent: `#b0a89e`,
        muted: `#1a1a1a`,
        subtle: `#c7c7c7`,
  ...
  shadows: {
    ...
    outline: `0 0 0 4px rgba(138, 123, 108, 0.18)`,
    neon: neonGlow,
  ...
  styles: {
    root: {
      ...
      "::selection": {
        backgroundColor: `rgba(122, 107, 93, 0.16)`,
        color: `text`,
      },
      img: {
        maxWidth: `100%`,
      ...
      a: {
        ...
        "&:hover": {
          color: `primary`,
          textShadow: `0 0 6px rgba(138, 123, 108, 0.16)`,
        },
      },
    },
    p: {
