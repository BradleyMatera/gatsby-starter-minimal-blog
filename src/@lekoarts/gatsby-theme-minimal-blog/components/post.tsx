...
const allHouseAds: HouseAd[] = [
  // Projects & experiments
  {
    ...
    category: "Project",
    title: "ProjectHub",
    body: "An AI-powered portfolio and recruiter assistant named Scout. Visitors can ask questions about Bradley Matera's projects, technical skills, certifications, education, and professional background instead of searching through multiple portfolio pages.",
    cta: "Visit ProjectHub",
  ...
  },
  {
    ...
    body: "Select a base color, generate a complete color palette, and preview how those colors look across interface components. Demonstrates interactive color controls, reusable design systems, live previews, and modern UI development.",
    cta: "View on CodePen",
  ...
  },
  {
    ...
    body: "A fan-made Pokémon web application that lets users search, filter, and explore information about different Pokémon. Demonstrates responsive design, API data handling, interactive controls, and organized information display.",
    cta: "Open Pokédex",
  ...
  },
  {
    ...
    label: "CodePen demo",
    category: "Demo",
    title: "Squirtle MySpace Profile",
    body: "A CodePen project that recreates the look and personality of an early-2000s MySpace profile using a Pokémon theme. Includes retro navigation, neon colors, profile sections, bulletins, comments, animations, and a nostalgic Top 8 friends layout.",
    cta: "View on CodePen",
  ...
  },
  {
    ...
    category: "Project",
    title: "Animal Sounds",
    body: "An interactive wildlife soundboard that lets users explore and play sounds from different animals. Combines visual animal cards, audio controls, responsive design, and an accessible interface for an educational and entertaining experience.",
    cta: "Play soundboard",
  ...
  },
  {
    ...
    label: "Live tutorial",
    category: "Tutorial",
    title: "Node.js Secrets and Environment Variables Guide",
    body: "An interactive security guide that explains different ways applications handle API keys, passwords, and other sensitive information. Compares unsafe hardcoded secrets with safer approaches such as environment variables and cloud-based secret management.",
  ...
  },
  {
    ...
    category: "Project",
    title: "CheeseMath",
    body: "A modern calculator and JavaScript testing project that includes standard arithmetic, string utilities, regular-expression tools, and secure card-number obscuring. Created to demonstrate application logic, component development, input validation, and automated testing with Jest.",
    cta: "Try CheeseMath",
