...
export const Head: HeadFC = () => (
  <>
    <Seo
      title="Blog"
      description="Short breakdowns of fixes, experiments, and lessons from cloud and full-stack work — AWS, React, Docker, CI/CD, and honest project notes from a junior software engineer."
      pathname="/blog/"
